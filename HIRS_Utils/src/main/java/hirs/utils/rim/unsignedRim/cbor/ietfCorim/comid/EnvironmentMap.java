...
/**
 * A class that defines an <i>environment</i>, which is context-dependent but can represent either an Attester, an
 * Attesting Environment, or a Target Environment.
 * <p>
...
public class EnvironmentMap {
     ...
     */
    public EnvironmentMap(CBORItem envMapNode) {
        ...
        for (var pair : pairs) {
            ...
            if (currVal != null) {
                switch (currVal) {
                    case CLASS_MAP -> comidClass = new ComidClass(pair.getValue());
