 ...
 *     spec is currently missing value for rimLinkHash, componentManufacturerID, firmwareVersion, so these values are made up
 *     Missing componentManufacturerID in table 4
 *     missing bindingSpecVersion in table 4 but has value assigned in section
 */
public class TcgCompRimCoswid extends Coswid {
    ...
    protected static final String CRIM_SPDM_MEASUREMENT_VALUE_TYPE_STR = "spdm-dmtf-spec-measurement-value-type";
     ...
     */
    public static String lookupFieldName(int index) {
        String value = "";
        ...
        switch (index) {
                ...
                case CRIM_TCG_COMPONENT_RIM_SW_META_INT: value = CRIM_TCG_COMPONENT_RIM_SW_META_ENTRY_STR; break;
                case CRIM_TCG_COMPONENT_RIM_PAYLOAD_INT: value = CRIM_TCG_COMPONENT_RIM_PAYLOAD_ENTRY_STR; break;
                ...
                case CRIM_SPDM_MEASUREMENT_BLOCK_INDEX_INT: value= CRIM_SPDM_MEASUREMENT_BLOCK_INDEX_STR; break;
     ...
     * @param key: label (name) given to the CDDL extension points defined by the TCG Component Rim Binding specification
     */
