...
/**
 * A class that defines a <i>linked tag map</i>, representing a typed relationship between the source CoMID tag and the
 * target CoMID tag. See Section 5.1.3 of the IETF CoRIM specification.
 */
@Getter
@Setter
...
public class LinkedTagMap {
     ...
     */
    public LinkedTagMap(CBORItem linkedTagMap) {
            ...
            if (currVal != null) {
                switch (currVal) {
                    ...
                    case TAG_REL -> {
                        ...
                        if (currTagRelType != null) tagRelTypeChoice = currTagRelType;
                    }
                }
            }
        }
