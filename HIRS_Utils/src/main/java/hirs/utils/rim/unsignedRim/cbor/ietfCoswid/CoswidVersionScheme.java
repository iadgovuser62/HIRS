...
import hirs.utils.rim.unsignedRim.cbor.ietfCorim.comid.VersionMap;
 ...
 * the version pertaining to a measured environment, used in {@link VersionMap}.
...
public class CoswidVersionScheme {
    ...
    CoswidVersionSchemeType coswidVersionSchemeType;
    /** Corresponds to the {@code int} choice for the {@code $version-scheme} type.*/
    Integer versionSchemeInt;
    /** Corresponds to the {@code text} choice for the {@code $version-scheme} type.*/
    String versionSchemeText;

    /**
     * Creates an object corresponding to a {@code $version-scheme}. To create, either a valid index corresponding to
     * the table found in Section 4.1 of RFC 9393 is used, or a text string (user-defined).
     *
     * @param object The object to be used during the version scheme creation.
     */
    public CoswidVersionScheme(Object object) {
