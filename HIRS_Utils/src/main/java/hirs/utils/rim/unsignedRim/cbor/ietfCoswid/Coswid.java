...
/**
 * Class that processed CoSWID (rfc 9393) Defined attributes, attribute names, and assigned indexes
 *  Naming convention for variables is SPEC_LABEL_STR or INT but...
 *  Items defined in SWID starts with SWID_.
 *  Corresponding Index (int) values are defined by CoSWID and start with COSWID_.
 */
@Setter
@Getter
public class Coswid extends Swid implements GenericRim
{
    ...
    public static int ianaTag = 1398229316;
