...
/**
 * Class that stores the attributes of a Measurement Hash from a CoSWID file.
 */
@Getter
@Setter
public class Measurement {
    ...
    /**
     * Default toString that contains the attributes of a Measurement Hash from a CoSWID file.
     */
    public String toString() {
        String measurementData = "";
        HexFormat hexTool =  HexFormat.of();

        measurementData += "  Measurement Type: " + measurementType.getName() + "\n";
