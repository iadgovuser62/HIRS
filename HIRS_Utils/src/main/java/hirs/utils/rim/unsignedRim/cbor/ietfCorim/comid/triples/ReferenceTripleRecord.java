...
/**
 * A class corresponding to a <i>reference values triple</i>, and comprises a set of reference measurements or claims
 * pertaining to a specific environment.
 * <p>
...
public class ReferenceTripleRecord {
     ...
     */
    EnvironmentMap refEnv;
    /**
     * Corresponds to the {@code ref-claims} field. Comprises a list of <i>reference claims</i>, which are measurements
     * associated with the environment.
     */
    List<MeasurementMap> refClaims;
     ...
     */
    public ReferenceTripleRecord(CBORItem refTripleRecord) {
