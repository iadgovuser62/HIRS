...
/**
 *  Class that processes a {@code digest} containing hash information relevant to CoMID measurements. See Section 7.7
 *  of the IETF CoRIM specification.
 */
@Getter
@Setter
public class ComidDigest {
    /** Corresponds to the {@code alg} field, identifying the digest algorithm used. Available algorithms are detailed
     * in the IANA Hash Algorithm Registry.
     * @see <a href="https://www.iana.org/assignments/named-information/named-information.xhtml">IANA Hash Algorithm
     * Registry</a>*/
    @JsonProperty("alg")
    IanaHashAlg alg;
    ...
    public ComidDigest(CBORItem comidDigest)
    {
