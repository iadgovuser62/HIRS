...
public enum IanaHashAlg {
    ...
    IanaHashAlg(int algId, String algName, String algLength) {
        this.algId = algId;
     ...
     */
    public static IanaHashAlg getAlgFromId(int alg) {
     ...
     */
    public static IanaHashAlg getAlgFromName(String algName) {
        for (IanaHashAlg alg : values()) {
